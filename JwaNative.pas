...
// $Id: JwaNative.pas,v 1.10 2005/04/28 20:00:20 assarbad Exp $
...
//
  ...
  FILE_ATTRIBUTE_READONLY = $00000001; // JwaWinNT.pas
  FILE_ATTRIBUTE_HIDDEN = $00000002; // JwaWinNT.pas
  FILE_ATTRIBUTE_SYSTEM = $00000004; // JwaWinNT.pas
//OLD DOS VOLID                               = $00000008

  FILE_ATTRIBUTE_DIRECTORY = $00000010; // JwaWinNT.pas
  FILE_ATTRIBUTE_ARCHIVE = $00000020; // JwaWinNT.pas
  FILE_ATTRIBUTE_DEVICE = $00000040; // JwaWinNT.pas
  FILE_ATTRIBUTE_NORMAL = $00000080; // JwaWinNT.pas

  FILE_ATTRIBUTE_TEMPORARY = $00000100; // JwaWinNT.pas
  FILE_ATTRIBUTE_SPARSE_FILE = $00000200; // JwaWinNT.pas
  FILE_ATTRIBUTE_REPARSE_POINT = $00000400; // JwaWinNT.pas
  FILE_ATTRIBUTE_COMPRESSED = $00000800; // JwaWinNT.pas

  FILE_ATTRIBUTE_OFFLINE = $00001000; // JwaWinNT.pas
  FILE_ATTRIBUTE_NOT_CONTENT_INDEXED = $00002000; // JwaWinNT.pas
  FILE_ATTRIBUTE_ENCRYPTED = $00004000; // JwaWinNT.pas
...
function  ZwQueryInformationProcess(ProcessHandle: HANDLE; ProcessInformationClass: PROCESSINFOCLASS; ProcessInformation: PVOID; ProcessInformationLength: ULONG; ReturnLength: PULONG): NTSTATUS; stdcall; {$IFNDEF RTDL}external ntdll;
   {$ENDIF}
